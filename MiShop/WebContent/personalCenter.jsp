...
<div class="centain">
    <div class="c_person">
        <a class="queryCtrl" href="index.jsp">首页</a>
        <span>> 个人中心</span>
    </div>
    <div class="c_main">
        <div class="c_m_list">
            <ul class="c_m_l_nav">
                ...
                <li>
                    <a href="pass-update.jsp">修改密码</a>
                </li>
            </ul>
        </div>
        <div class="c_m_info">
            <p class="c_m_i_personal">个人信息</p>
            <ul class="c_m_i_list">
                ...
                <li class="c_m_i_l_fir">
                    ...
                    <span class="c_m_i_l_f_realName">${USER.userRealName}</span>
                </li>
                <li class="c_m_i_l_fir">
                    <span class="left">性别：</span>
                    <span class="c_m_i_l_f_sex">${USER.sex}</span>
                </li>
                <li class="c_m_i_l_fir">
                    <span class="left">生日：</span>
                    <span class="c_m_i_l_f_bir">${USER.birthday}</span>
                </li>
                <li class="c_m_i_l_fir">
                    <span class="left">电话：</span>
                    <span class="c_m_i_l_f_tel">${USER.tel}</span>
                </li>
                <li class="c_m_i_l_fir">
                    <span class="left">邮箱：</span>
                    <span class="c_m_i_l_f_email">${USER.email}</span>
                </li>
                <!--<input type="radio" name="sex" valu2="1">
                <input type="radio" name="sex" value="2">
                <input type="date"/>-->
                <!--<li class="c_m_i_l_fif">
                    <span class="left">收货地址：</span>
                    <span class="c_m_i_l_fi_answer">1816181719</span>
                </li>-->
            </ul>
            <button class="c_m_i_edit">编辑</button>
        </div>
