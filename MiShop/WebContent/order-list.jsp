...
<div class="centain">
    <div class="c_person">
        <a class="c_p_index" href="queryCtrl">首页</a>
        <span>> 订单中心</span>
    </div>
    <div class="c_main">
        <div class="c_m_list">
        ...
        <div class="c_m_info">
            <p class="c_m_i_personal">订单中心</p>
            <table class="c_m_i_header">
                <tr class="c_m_i_h_th">
                    <td class="c_m_i_h_info">商品信息</td>
            ...
            <c:choose>
                 <c:when test="${not empty page.pageData}">
                     <c:forEach var="order" items="${page.pageData}">
                        <table class="c_m_i_item">
			                <tr>
			                    <td class="c_m_i_i_fir" colspan="5">
			                        <span>订单号：</span>
			                        <span class="c_m_i_i_t_orderNum">${order.orderNumber}</span>
			                        <span class="c_m_i_i_t_text">&nbsp;${order.createTime }</span>
			                        <span>收件人：</span>
			                        <span class="c_m_i_i_t_text">${order.receiver}</span>
			                        <span>订单状态：</span>
			                        <span  class="c_m_i_i_t_text">${order.status}</span>
			                        <span>总价：</span>
			                        <span class="c_m_i_i_t_price">${order.payment}</span>
			                        <a class="c_m_i_i_t_particulars" href="queryOrderItemCtrl?method=orderitem&orderId=${order.orderId}">查看详情></a>
			                    </td>
			                </tr>
                   ...
                   <div class="c_m_i_page" align="center">
		          	 	<c:if test="${not empty page.pageData}"></c:if>
		                  	<span>当前${page.currentPage }/${page.totalPage}页     &nbsp;&nbsp;</span>
		                   <c:if test="${page.currentPage!=1}">
			                   <a href="queryOrderCtrl?currentPage=1">首页</a>
			                   <a href="queryOrderCtrl?currentPage=${page.currentPage-1}">上一页 </a>
		                   </c:if>
		                   <c:if test="${page.currentPage!=page.totalPage }">
			                   <a href="queryOrderCtrl?currentPage=${page.currentPage+1}">下一页 </a>
			                   <a href="queryOrderCtrl?currentPage=${page.totalPage}">末页</a>
		                   </c:if>
		             </div>
                 </c:when>
                 <c:otherwise>
                    <p class="c_m_text">您还没有订单</p>
                  </c:otherwise>
          	 </c:choose>
